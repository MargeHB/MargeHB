...
<div class="p-3">
    ...
    <form action="editar" method="post">
        ...
        <table>
            ...
            <tr>
                <td class="p-2"><label for="observacion">Observación:</label></td>
                <td><input class="form-control" type="text"
                           placeholder="observacion" name="observacion" value="${VO.getObservacion()}" /></td>
            </tr>
            
             <tr>
                <td class="p-2"><label for="clasificacion">Clasificación:</label></td>
                <td><input class="form-control" type="text"
                           placeholder="observacion" name="observacion" value="${VO.getObservacion()}" /></td>
            </tr>
